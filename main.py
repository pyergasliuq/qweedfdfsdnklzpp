...
PRESETS = {
    "1": {"name": "⚡ Ускор + Антик", "folder": "", "desc": "Ускоренная стрельба, антикилл, раскрывающийся прицел"},
    "2": {"name": "🔄 Без перезарядки + Динамичный", "folder": "", "desc": "Без перезарядки, динамичный прицел"},
    "3": {"name": "🎯 Без перезарядки + Статичный", "folder": "", "desc": "Без перезарядки, статичный прицел"},
}
